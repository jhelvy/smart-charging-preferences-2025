...
# coef(smc_mnl_model)
# smc_mnl_model$coefficients["no_choice"] <- 5
...
smc_mnl_sens_combined_data$value <- c(
    "$300",
    "$50",
    "$20",
    "$2",
...
v2g_mnl_sens_combined_data$value <- c(
    "$300",
    "$50",
    "$20",
    "$2",
