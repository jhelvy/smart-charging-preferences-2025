...
save(
    smc_mxl_model,
    file = file.path(processed_dir, "2_models", "smc_mxl_model.RData")
)
...
ggsave(
    filename = file.path(processed_dir, "2_models", "smc_mxl_plot.png"),
    plot = smc_mxl_plot,
    width = 6,
    height = 6 / 1.618
)
...
save(
    v2g_mxl_model,
    file = file.path(processed_dir, "2_models", "v2g_mxl_model.RData")
)
...
ggsave(
    filename = file.path(processed_dir, "2_models", "v2g_mxl_plot.png"),
    plot = v2g_mxl_plot,
    width = 6,
    height = 6 / 1.618
)
